        ...
        if (TAPi18n.getLanguage() === 'es') {
          return [
            ...
            {id: Random.id(6), 
              ...
              color: 'indigo-text .text-darken-4', 
              label: 'Grande', 
              value: 'Principal / Grande / 19 m2 $5225 usd', 
              cost: '19 m2, $5225 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              ...
              cost: 'Please contact us at <a href="mailto:applications@material-fair.com">applications@material-fair.com</a> for more information.',},
          ];
        } else {
          return [
            {id: Random.id(6), 
              ...
              color: 'teal-text', 
              label: 'Single', 
              value: 'Project / Single / 3 m2 $525 usd', 
              cost: '3 m2, $525 usd',},
            {id: Random.id(6), 
              type: 'Project', 
              color: 'teal-text', 
              label: 'Double', 
              value: 'Project / Double / 6 m2 $1050 usd', 
              cost: '6 m2, $1050 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Small', 
              value: 'Principal / Small / 9 m2 $2475 usd', 
              cost: '9 m2, $2475 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium', 
              value: 'Principal / Medium / 12 m2 $3300 usd', 
              cost: '12 m2, $3300 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium Plus', 
              value: 'Principal / Medium Plus / 16 m2 $4400 usd', 
              cost: '16 m2, $4400 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Large', 
              value: 'Principal / Large / 19 m2 $5225 usd', 
              cost: '19 m2, $5225 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
