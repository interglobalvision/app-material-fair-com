        ...
        if (TAPi18n.getLanguage() === 'es') {
          return [
            {id: Random.id(6), 
              ...
              color: 'teal-text', 
              label: 'Sencillo', 
              value: 'Proyecto / Sencillo / 3 m2, $525 usd', 
              cost: '3 m2, $525 usd',},
            {id: Random.id(6), 
              type: 'Proyecto', 
              color: 'teal-text', 
              label: 'Doble', 
              value: 'Proyecto / Doble / 6 m2, $1050 usd', 
              cost: '6 m2, $1050 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Chico', 
              value: 'Principal / Chico / 9 m2, $2475 usd', 
              cost: '9 m2, $2475 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Mediano', 
              value: 'Principal / Mediano / 12 m2, $3300 usd', 
              cost: '12 m2, $3300 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Mediano Plus', 
              value: 'Principal / Mediano Plus / 16 m2, $4400 usd', 
              cost: '16 m2, $4400 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Grande', 
              value: 'Principal / Grande / 24 m2, $6600 usd', 
              cost: '24 m2, $6600 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Extra Grande', 
              value: 'Principal / Extra Grande', 
          ...
          return [
            {id: Random.id(6), 
              ...
              color: 'teal-text', 
              label: 'Single', 
              value: 'Project / Single / 3 m2 (approx. 32 sq. ft.), $525 usd', 
              cost: '3 m2 (approx. 32 sq. ft.), $525 usd',},
            {id: Random.id(6), 
              type: 'Project', 
              color: 'teal-text', 
              label: 'Double', 
              value: 'Project / Double / 6 m2 (approx. 64 sq. ft.), $1050 usd', 
              cost: '6 m2 (approx. 64 sq. ft.), $1050 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Small', 
              value: 'Principal / Small / 9 m2 (approx. 97 sq. ft.), $2475 usd', 
              cost: '9 m2 (approx. 97 sq. ft.), $2475 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium', 
              value: 'Principal / Medium / 12 m2 (approx. 129 sq. ft.), $3300 usd', 
              cost: '12 m2 (approx. 129 sq. ft.), $3300 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium Plus', 
              value: 'Principal / Medium Plus / 16 m2 (approx. 172 sq. ft.), $4400 usd', 
              cost: '16 m2 (approx. 172 sq. ft.), $4400 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Large', 
              value: 'Principal / Large / 24 m2 (approx. 258 sq. ft.), $6600 usd', 
              cost: '24 m2 (approx. 258 sq. ft.), $6600 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Extra Large', 
              value: 'Principal / Extra Large', 
