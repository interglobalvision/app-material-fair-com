        ...
        if (TAPi18n.getLanguage() === 'es') {
          ...
          return [
            ...
            {id: Random.id(6), 
              ...
              color: 'indigo-text .text-darken-4', 
              label: 'Small', 
              value: 'Pricipal / Small / 9 m2 $2475 usd', 
              cost: '9 m2, $2475 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium', 
              value: 'Pricipal / Medium / 12 m2 $3300 usd', 
              cost: '12 m2, $3300 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Medium Plus', 
              value: 'Pricipal / Medium Plus / 16 m2 $4400 usd', 
              cost: '16 m2, $4400 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Large', 
              value: 'Pricipal / Large / 19 m2 $5225 usd', 
              cost: '19 m2, $5225 usd',},
            {id: Random.id(6), 
              type: 'Principal', 
              color: 'indigo-text .text-darken-4', 
              label: 'Extra Large', 
              value: 'Pricipal / Extra Large', 
              cost: 'Please contact us at <a href="mailto:applications@material-fair.com">applications@material-fair.com</a> for more information.',},
          ];
        }
      },
